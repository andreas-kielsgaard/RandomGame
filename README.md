...
Iteration 5 has playable loops for Levels 1 through 4. Each playable level includes generated placeholder art, platforming, camera follow, checkpoint respawn, psychedelic hazards, one collectible ingredient, an NPC quest giver, dialogue interaction, and an exit portal gated by the quest item. Level 5 has story, NPC, quest, ingredient, and artifact-component metadata in `src/data/levels.js`, but remains a coming-soon finale screen for now.
